...
// //using properties we declared to customize refresh control
// refreshControl.setMaxHeightOfRefreshControl = 200
// refreshControl.setRefreshCircleSize = .medium

//To call a function when refresh is triggered.
// refreshControl.setOnRefreshing = {[weak self] in
//call your function here
//and don’ forget to call “refreshControl.endRefreshing()” at end of that task you perform inside that function
// }
